...
public class Scenario3 {
	...
	public static void main(String[] args) throws Throwable {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//td[2]//img[@style=\"padding: 0px;padding-left:5px\"]")).click();
		Thread.sleep(1000);
